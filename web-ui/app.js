 ...
 */
dotenv.load({ path: '/var/soundserver/web-ui/.env.example' });
...
app.get('/soundserver/status', passportConfig.isAuthenticated, soundserverController.getStatus);
app.get('/soundserver/settings', passportConfig.isAuthenticated, soundserverController.getSettings);
app.post('/soundserver/settings', passportConfig.isAuthenticated, soundserverController.postSettings);
/**
 * Error Handler.
 */
